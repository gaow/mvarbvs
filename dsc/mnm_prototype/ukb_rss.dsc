...
DSC:
  ...
  run:
    ...
    small2_compare: data_ukb * artificial_mixture_ukb_small2 * ((mnm_rss_naive, mnm_rss_naive_corY, mnm_rss_naive_corZ) * mvsusie_scores, FLASHFMwithFINEMAP * flashfm_scores) # PAINTOR
