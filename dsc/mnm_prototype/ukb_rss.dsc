...
DSC:
  ...
  run:
    ...
    small2_compare: data_ukb * artificial_mixture_ukb_small2 * ((mnm_rss_naive, mnm_rss_naive_corY, mnm_rss_naive_corZ) * mvsusie_scores, PAINTOR)
  ...
  global:
    ...
    # Settings for small4_compare
    # varY_file: '/project2/mstephens/yuxin/ukb-bloodcells/analysis_20220619/artificial_small4.Ycor.rds'
