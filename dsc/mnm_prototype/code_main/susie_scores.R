...
susie_scores_multiple = function(res, truth) {
  total = valid = top = objective = converged = cs_corr = expected = vector()
  ...
  return(list(total=total, valid=valid, size=size, purity=purity, avgr2=avgr2, top=top, expected = expected,
