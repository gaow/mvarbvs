...
ggsave("../plots/bloodcells_finemap_ext1_samd12_pips.eps",
       plot_grid(p1$pip_plot,p2$plot,nrow = 2,ncol = 1,align = "v",axis = "lr",
                 rel_heights = c(2,1)),
       height = 2.75,width = 7)
ggsave("../plots/bloodcells_finemap_ext1_samd12_effects.eps",
...
ggsave("../plots/bloodcells_finemap_tns3_pips.eps",
       plot_grid(p1$pip_plot,p2$plot,nrow = 2,ncol = 1,align = "v",axis = "lr",
                 rel_heights = c(2,1)),
       height = 2.75,width = 7)
ggsave("../plots/bloodcells_finemap_tsn3_effects.eps",
...
ggsave("../plots/bloodcells_finemap_runx1_pips.eps",
       plot_grid(p1$pip_plot,p2$plot,nrow = 2,ncol = 1,align = "v",axis = "lr",
                 rel_heights = c(2,1)),
       height = 3.25,width = 7)
ggsave("../plots/bloodcells_finemap_runx1_effects.eps",
...
ggsave("../plots/bloodcells_finemap_zfpm1_piezo1_pips.eps",
       plot_grid(p1$pip_plot,p2$plot,nrow = 2,ncol = 1,align = "v",axis = "lr",
                 rel_heights = c(2,1)),
       height = 3.25,width = 7)
ggsave("../plots/bloodcells_finemap_zfpm1_piezo1_effects.eps",
       p1$effect_plot,height = 3.25,width = 4)
